...
export type Contact = {
  ...
  _updatedAt: string;
  _rev: string;
  implementationTiming?: "immediately" | "withinOneMonth" | "withinThreeMonths" | "withinSixMonths" | "informationGathering";
  inquiryContent?: string;
  interestedService?: "develop" | "marketing" | "consulting";
  companyName?: string;
  companyUrl?: string;
  name?: string;
  mail?: string;
...
export type Category = {
  ...
  _rev: string;
  title?: string;
  internationalizedTitle?: InternationalizedArrayString;
  orderRank?: string;
};
...
// Variable: postsQuery
// Query: *[_type == 'post'] | order(_updatedAt desc) {      slug,      _updatedAt    }
export type PostsQueryResult = Array<{
  slug: Slug | null;
  _updatedAt: string;
}>;
// Variable: companiesQuery
// Query: *[_type == 'company'] | order(_updatedAt desc) {      slug,      _updatedAt    }
export type CompaniesQueryResult = Array<{
  slug: Slug | null;
  _updatedAt: string;
}>;
// Variable: servicesQuery
// Query: *[_type == 'service'] | order(_updatedAt desc) {      slug,      _updatedAt    }
...
export type CATEGORY_QUERYResult = Array<{
  _id: string;
  title: string | null;
  internationalizedTitle: InternationalizedArrayString | null;
}>;
...
// Query: *[_type == "post" && defined(slug) && language == $language && category->title != "News"] | order(_createdAt desc){    title,    slug,    excerpt,    image{      asset->{        _id,        url,        mimeType,        metadata { lqip, dimensions { width, height } }      },      alt    },}
...
// Query: *[_type == "post" && defined(slug) && language == $language && category->title != "News"] | order(_createdAt desc){  title,  slug,  excerpt,  category->{    _id,    title,    internationalizedTitle  },  image{    asset->{      _id,      url,      mimeType,      metadata { lqip, dimensions { width, height } }    },    alt  },}
...
// Variable: NEWS_POSTS_QUERY
// Query: *[_type == "post" && defined(slug) && language == $language && category->title == "News"] | order(_createdAt desc){  title,  slug,  _createdAt}
export type NEWS_POSTS_QUERYResult = Array<{
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
}>;
// Variable: POSTS_SLUGS_QUERY
// Query: *[_type == "post" && defined(slug) && language == $language]{slug}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"post\" && defined(slug) && language == $language && category->title != \"News\"] | order(_createdAt desc){\n    title,\n    slug,\n    excerpt,\n    image{\n      asset->{\n        _id,\n        url,\n        mimeType,\n        metadata { lqip, dimensions { width, height } }\n      },\n      alt\n    },\n}": POSTS_QUERYResult;
