...
// Query: *[_type == "post" && defined(slug) && language == $language && !("News" in categories[]->title)] | order(_createdAt desc){    title,    slug,    excerpt,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },}
